...
public class ComplexReportFactory {
    ...
    private static final Map<Long, String> threadToExtentTestMap = new HashMap<Long, String>();
    private static final Map<String, ExtentTest> nameToTestMap = new HashMap<String, ExtentTest>();
